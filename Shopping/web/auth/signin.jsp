        ...
        <div class="container">
            <form class="form-horizontal" role="form" action="./../AccountController" method="POST" name="register">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" id="password" required="Password can not empty" name="cPassword" placeholder="Password" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" >
                    ...
                    <div  class="col-sm-9 ">
                        <select name="gender" >
                            <option style="color: #F6CEEC" class="Sex" value="Male">Nam</option>
                            <option style="color: #F6CEEC"  class="Sex" value="Female">Nữ</option>
                            <option style="color: #F6CEEC" class="Sex" value="Other">Khác</option>
                        </select>
                    </div>
